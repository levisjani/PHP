...
<div align="center">
	<table border="0" width="100%" cellspacing="1" height="100%" id="table1">
		...
		<tr >
			...
			<?php
			$id=$_GET["id"];
			$sql="select s.*, q.* from s_survey_master s, s_question_master q where q.q_sm_id=s.sm_id and s.sm_id =".$id;
			...
			if ($row_count>0)
			{
				...
				echo("Survey Result for : <b>".$sm_name."<br> &nbsp;</b>");
				$i=0;
				...
				{	
					...
					$sql2="select * from s_question_options where o_q_id=".$q_id." order by o_id";
					...
					if ($row_count2>0)
					{
						...
						if($q_type=='Single Image Selection' || $q_type=='Multiple Image Selectio')
						{
							...
							$txt_op1="<img src=survey_images\\".$txt_op1.">";
							$txt_op2="<img src=survey_images\\".$txt_op2.">";
							$txt_op3="<img src=survey_images\\".$txt_op3.">";
							$txt_op4="<img src=survey_images\\".$txt_op4.">";
							
						}
						
						//calculate results and percentage
						$sql3="SELECT * FROM s_user_survey_details where usd_q_id=".$q_id." order by usd_id ";
