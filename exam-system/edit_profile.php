...
$result = mysql_query("select * from s_user_master where um_name='$_SESSION[username]'");
...
if($_POST['BtnSubmit']=='Submit')
{
	...
	//update
	$sql_update = "update s_user_master set um_email_id='$um_emailid',um_password='$um_password'
								where um_id=$um_id;";
