...
&nbsp;<?php
					...
					//get category
					$result = mysql_query("SELECT q.q_id, e.em_name, q.q_text FROM question_master  q, exam_master e where q.q_em_id=e.em_id  and q_create_by=".$_SESSION['userid']);
			...
			<table border="1" width="560" cellspacing="1" id="table12" style="border-collapse: collapse">
				...
				<tr>
					...
					<td width="200" class="td_tablehead">Survey</td>
					<td width="205" class="td_tablehead">Question</td>
				...
				if ($count>0)
				{
					...
					for($i=0;$i<$count; $i++)
					{
						...
						echo("<tr>");
							...
							echo("<td width='200' align ='left' valign ='top'>".mysql_result($result,$i,"em_name")."</td>");
							echo("<td width='205' align ='left' valign ='top'>".mysql_result($result,$i,"q_text")."</td>");
