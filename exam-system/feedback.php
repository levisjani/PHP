...
<?php
	...
	if($_POST['BtnSubmit']=='Submit')
	{
	 	...
	 	$result1=mysql_query("select IFNULL(max(f_id),0)+1 m from s_feedback");	
	 	$f_id=mysql_result($result1,0,"m");
		
		$t_subject=$_POST['TxtSubject'];
		$t_feedback=$_POST['TxtFeddback'];
		
		$sql="insert into s_feedback values($f_id,sysdate(),'$t_subject','$t_feedback',$userid)";
