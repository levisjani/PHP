...
if($_POST['BtnSubmit']=='Submit')
{
	...
	$rs_duplicate = mysql_query("select count(*) as total from s_user_master where um_email_id='$um_emailid' OR um_name='$um_name'") or die(mysql_error());
	...
	//get max id
	$qr_id = mysql_query("select max(um_id) + 1 from s_user_master ") or die(mysql_error());
	list($um_id) = mysql_fetch_row($qr_id);
	
	//insert
	$sql_insert = "INSERT into s_user_master

		    VALUES
		    ($um_id,'$um_name','$um_password','$um_emailid','$usertype',now(),null,null,1)";
